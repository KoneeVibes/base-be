...
app.use(
	...
	require("./route/inbound/user"),
);
app.use(
	"/user/gallery",
	require("./middleware/authorization"),
	require("./route/inbound/gallery"),
);
app.use(
	"/user/blog",
	require("./middleware/authorization"),
	require("./route/inbound/blog"),
);
app.use(
	"/user/multimedia",
	require("./middleware/authorization"),
	require("./route/inbound/multimedia"),
);
app.use(
	"/user/:userId/project",
	require("./middleware/authorization"),
	require("./route/inbound/project"),
);
...
app.use(
	...
	require("./route/outbound/gallery"),
);
app.use(
	"/public/blog",
	require("./middleware/authentication"),
	require("./route/outbound/blog"),
);
